...
T.ScrollBar {
    ...
    property int radius: ThemeEngine.isDesktop ? 0 : 8

    property color colorBackground: ThemeEngine.colorBackground
    property color colorMoving: ThemeEngine.colorSecondary
    property color colorPressed: ThemeEngine.colorPrimary
